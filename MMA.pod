...
length associated with the array.  This option is useful for "records"
...
In general the I<mm_hash_get_entry> call is a better choice than 
...
These values represent:
  ...
  $nvSize      the size of an NV (a Perl floating point vale, in bytes)
...
performance, and for large numbers of entries a binary search is 
